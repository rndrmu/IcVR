...
## Usage
1. [Download the master.zip of this Repo](https://github.com/duckforceone/IcyViewR/archive/master.zip) [Or the beta](https://github.com/duckforceone/IcyViewR/archive/beta.zip) <- Hyperlink for easier access :)
